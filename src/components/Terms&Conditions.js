...
export default function Terms_Conditions() {
    return (
        <div className="container" style={{ fontFamily: "Inter" }}>
            ...
            <p>
                The terms "We" / "Us" / "Our"/”Company” individually and collectively refer to digiFin and the terms "Visitor” ”User” refer to the users.
            </p>
            <p>
            ...
            <p>
                The User unilaterally agree to indemnify and hold harmless, without objection, the Company, its officers, directors, employees and agents from and against any claims, actions and/or demands and/or liabilities and/or losses and/or damages whatsoever arising from or resulting from their use of digi.ghostvaibhav.me or their breach of the terms .
            </p>
            <p>
