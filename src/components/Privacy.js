...
export default function Privacy() {
    return (
        <div className="container" style={{ fontFamily: "Inter" }}>
            <h1 className="my-3" style={{ fontWeight: 700 }}>Privacy Policy</h1>
            <p>
                The terms "We" / "Us" / "Our"/”Company” individually and collectively refer to digiFin and the terms "You" /"Your" / "Yourself" refer to the users.
            </p>
            <p>
                This Privacy Policy is an electronic record in the form of an electronic contract formed under the information Technology Act, 2000 and the rules made thereunder and the amended provisions pertaining to electronic documents / records in various statutes as amended by the information Technology Act, 2000. This Privacy Policy does not require any physical, electronic or digital signature.
            </p>
            <p>
                This Privacy Policy is a legally binding document between you and digiFin (both terms defined below). The terms of this Privacy Policy will be effective upon your acceptance of the same (directly or indirectly in electronic form, by clicking on the I accept tab or by use of the website or by other means) and will govern the relationship between you and digiFin. for your use of the website “Website” (defined below).
            </p>
            <p>
